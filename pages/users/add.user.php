    ...
    <main class="main-wrapper">
        ...
        <section class="section">
            <div class="container-fluid">
                ...
                <form action="ctrlData/ctrl.add.user.php" class="form-elements wrapper" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-check radio-style mb-20">
                                                <input class="form-check-input" type="radio" value="1" id="roleradio-1" name="role" required/>
                                        ...
                                        <div class="col">
                                            <div class="form-check radio-style mb-20">
                                                <input class="form-check-input" type="radio" value="2" id="roleradio-2" name="role" required/>
